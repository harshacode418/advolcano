...
# Runtime configuration sourced from settings / environment variables
SENDGRID_API_KEY = getattr(settings, "SENDGRID_API_KEY", "")
ADMIN_EMAIL = getattr(settings, "ADMIN_EMAIL", "sales@advolcano.io")
VERIFIED_SENDER_EMAIL = getattr(
    settings,
    "VERIFIED_SENDER_EMAIL",
    getattr(settings, "FROM_EMAIL", "noreply@advolcano.io"),
)
